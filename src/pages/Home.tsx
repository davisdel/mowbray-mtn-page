...
export default function HomePage() {
  return (
    <div className="min-h-screen">
      {/* Hero Section */}
      <section className="relative h-screen flex items-center justify-center bg-hero-gradient text-primary-foreground overflow-hidden">
        ...
        <div className="relative z-10 text-center max-w-4xl mx-auto px-6">
          ...
          <p className="text-xl md:text-2xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
            Discover luxury living in a vibrant community designed for modern families. 
            Where comfort meets elegance, and neighbors become family.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground px-8 py-6 text-lg font-semibold shadow-strong">
        ...
        <div className="container mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-bold text-foreground mb-4">
              Why Choose CommunityPlace?
            </h2>
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Experience the perfect blend of modern amenities, natural beauty, and community spirit.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            ...
            <Card className="text-center border-0 bg-card shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-2">
              ...
              <CardContent>
                <CardDescription className="text-base">
                  Join a welcoming community with regular events, activities, and shared spaces for all ages.
                </CardDescription>
              </CardContent>
            </Card>
            ...
            <Card className="text-center border-0 bg-card shadow-soft hover:shadow-medium transition-all duration-300 hover:-translate-y-2">
              ...
              <CardContent>
                <CardDescription className="text-base">
                  24/7 security, gated access, and well-lit pathways ensure peace of mind for your family.
                </CardDescription>
              </CardContent>
            </Card>
          </div>
      ...
      <section className="py-20 bg-primary text-primary-foreground">
        <div className="container mx-auto px-6 text-center">
          ...
          <p className="text-xl mb-8 text-primary-foreground/90 max-w-2xl mx-auto">
            Schedule a visit today and experience the lifestyle you've been dreaming of.
          </p>
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Button 
              size="lg" 
